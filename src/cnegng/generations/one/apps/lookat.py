...
def render_graphviz_and_display(graphviz_str):
    ...
    try:
        ...
        print(f"\033]1337;File=inline=1;width=auto;height=auto;preserveAspectRatio=1:{output_image}\a")
...
if __name__ == "__main__":
    ...
    graphviz_str = renderer.render_full_grid_with_positions_and_sprites(grid, positions, sprites)
